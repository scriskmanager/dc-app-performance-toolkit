...
def test_1_selenium_view_project_matrix(jira_webdriver, jira_datasets, jira_screen_shots):
    modules.view_project_matrix(jira_webdriver, jira_datasets)

def test_1_selenium_view_project_rm_table(jira_webdriver, jira_datasets, jira_screen_shots):
    modules.view_project_rm_table(jira_webdriver, jira_datasets)
