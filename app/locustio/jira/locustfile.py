...
from extension.jira.extension_locust import app_specific_action_matrix, app_specific_action_table
...
class JiraBehavior(MyBaseTaskSet):
    ...
    def custom_action(self):
        app_specific_action_matrix(self)

    @task(config.percentage('standalone_extension'))  # By default disabled
    def custom_action_table(self):
        app_specific_action_table(self)
